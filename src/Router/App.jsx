...
const App = () => {
  ...
  useEffect(() => {
    ...
    // Cleanup garantizado — ambos se eyectan juntos
    return () => {
      axiosInstance.interceptors.request.eject(requestInterceptor);
      axiosInstance.interceptors.response.eject(responseInterceptor);
    };
  }, [USER_LOGGED, USER_TOKEN, dispatch]); // ← ambos comparten las mismas dependencias
  ...
  return (
    <AppTheme>
      ...
      <Loading />
      <Router>
        {USER_LOGGED ? <TokenExpirationChecker handleToastError={handleToastError} /> : null}
        ...
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              <Route path={Links.passwords} element={<Passwords handleToastError={handleToastError} />} />
              <Route
                path={Links.SignUp}
